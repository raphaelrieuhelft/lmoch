...
(*  b__6(n)  =  (if n=0 then true else aux__8(n))  *)
let def_b__6 n =
...
(*  n2__5(n)  =  (if n=0 then 0 else (if n=1 then 0 else (n2__5(n-2) + 2)))  *)
let def_n2__5 n =
...
(*  ok__3(n)  =  (if b__6(n) then aux__9(n) else true)  *)
let def_ok__3 n =
...
(*  (aux__9(n)  ==>  (n1__4(n) = n2__5(n)))  &&  ((n1__4(n) = n2__5(n))  ==>  aux__9(n))  *)
let def_aux__9 n =
...
(*  (aux__8(n)  ==>  not (b__6(n-1)))  &&  (not (b__6(n-1))  ==>  aux__8(n))  *)
let def_aux__8 n =
